        ...
        <div class="card shadow-sm border-0" style="border-radius: 12px;">
            <div class="card-header bg-white py-3" style="border-top: 3px solid #56823D; border-radius: 12px 12px 0 0;">
                <h5 class="mb-0 fw-bold" style="color: #2b2f32; font-size: 16px;">
                    <i class="bi bi-plus-circle-fill me-2" style="color: #56823D;"></i>Form Tambah Kartu Layanan Digital
                </h5>
            </div>
                ...
                <form action="{{ route('layanan-terkait.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div id="previewContainer" class="mt-3 d-none">
                            <label class="form-label text-muted small d-block">Preview Tampilan pada Kartu Layanan:</label>
