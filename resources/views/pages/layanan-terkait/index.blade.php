...
<div class="card shadow-sm border-0 mb-4" style="border-radius: 12px;">
    <div class="card-header bg-white py-3 d-flex align-items-center justify-content-between" style="border-top: 3px solid #79a8e2; border-radius: 12px 12px 0 0;">
        <h5 class="mb-0 fw-bold" style="color: #2b2f32; font-size: 16px;">
            <i class="bi bi-pencil-square me-2" style="color: #79a8e2;"></i>Pengaturan Judul & Deskripsi Seksi Layanan Terkait
        </h5>
        <span class="badge" style="background-color: #79a8e2; color: #ffffff; font-size: 11.5px; font-weight: 700; padding: 6px 12px; border-radius: 6px;">Frontend Header</span>
    </div>
        ...
        <form action="{{ route('layanan-terkait.update-setting') }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-12 text-end pt-2">
                    <button type="submit" class="btn fw-semibold shadow-sm" style="background-color: #79a8e2; color: #ffffff; border: none; padding: 8px 20px; border-radius: 8px;">
...
<div class="card shadow-sm border-0" style="border-radius: 12px;">
    <div class="card-header bg-white py-3 d-flex align-items-center justify-content-between" style="border-top: 3px solid #283759; border-radius: 12px 12px 0 0;">
        <h5 class="mb-0 fw-bold" style="color: #2b2f32; font-size: 16px;">
            <i class="bi bi-grid-fill me-2" style="color: #283759;"></i>Daftar Link & Kartu Layanan
        </h5>
        <a href="{{ route('layanan-terkait.create') }}" class="btn fw-semibold shadow-sm" style="background-color: #79a8e2; color: #ffffff; border: none; padding: 7px 18px; border-radius: 8px;">
