                ...
                <form action="{{ route('struktur-organisasi.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        @if(isset($struktur) && $struktur->url_struktur)
                            <button type="button" class="btn btn-danger" onclick="if(confirm('Apakah Anda yakin ingin menghapus gambar struktur organisasi?')) { document.getElementById('delete-form').submit(); }">
