        ...
        <div class="card shadow-sm">
            <div class="card-header py-3">
                <h5 class="mb-0 fw-semibold">
                    <i class="bi bi-pencil-square me-2 text-warning"></i>Form Edit Profil
                </h5>
            </div>
                ...
                <form action="{{ route('profil.update', $profil->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('nama_pemilik', $profil->nama_pemilik) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="alamat"
                                  ...
                                  rows="3"
                                  placeholder="Masukkan alamat lengkap">{{ old('alamat', $profil->alamat) }}</textarea>
                        @error('alamat')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div>
                                <img src="{{ asset('storage/' . $profil->logo) }}"
                                     alt="{{ $profil->nama_perusahaan ?? 'Logo' }}"
                    ...
                    <div class="mb-4">
                        ...
                        <div class="form-text">
                            ...
                            Kosongkan jika tidak ingin mengganti logo. Format: JPG, JPEG, PNG, GIF, SVG, WebP. Maks: 2 MB.
                        </div>
                        @error('logo')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
