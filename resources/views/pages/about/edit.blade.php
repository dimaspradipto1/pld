                ...
                <form action="{{ route('about.update', $about->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="border-bottom pb-3 mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="judul_profil" name="judul_profil" class="form-control @error('judul_profil') is-invalid @enderror" value="{{ old('judul_profil', $about->judul_profil) }}" placeholder="Contoh: Dedikasi Mencetak Pemimpin di Bidang Kesehatan">
                            @error('judul_profil')
