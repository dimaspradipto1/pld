        ...
        <div class="card shadow-sm">
            <div class="card-header py-3">
                <h5 class="mb-0 fw-semibold">
                    <i class="bi bi-plus-circle-fill me-2 text-primary"></i>Form Tambah Nilai
                </h5>
            </div>
            <div class="card-body pt-4">
                ...
                <form action="{{ route('nilaiperusahaan.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-sm-4">
                            ...
                            <input type="text" id="icon" name="icon"
                                   ...
                                   value="{{ old('icon') }}"
                                   placeholder="bi-shield-fill-check">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="deskripsi" name="deskripsi" rows="4"
                                  ...
                                  placeholder="Contoh: Mengutamakan keselamatan dan kesehatan kerja serta pelestarian lingkungan hidup dalam setiap kegiatan operasional.">{{ old('deskripsi') }}</textarea>
                        @error('deskripsi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
