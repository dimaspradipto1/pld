        ...
        <div class="card shadow-sm">
            <div class="card-header py-3">
                <h5 class="mb-0 fw-semibold">
                    <i class="bi bi-pencil-square me-2 text-warning"></i>Form Edit Tri Dharma
                </h5>
            </div>
                ...
                <form action="{{ route('tridharma.update', $tridharma->id) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-7 mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-light" id="icon-preview-box" style="font-size:22px;color:{{ old('warna', $tridharma->warna ?? '#823ca2') }};min-width:52px;justify-content:center;">
                                    <i id="preview-icon-el" class="bi {{ old('icon', $tridharma->icon) }}"></i>
                                </span>
                                <input type="text"
                                       id="icon"
                                       name="icon"
                                       class="form-control @error('icon') is-invalid @enderror"
                                       value="{{ old('icon', $tridharma->icon) }}"
                        ...
                        <div class="col-md-5 mb-3">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <input type="color"
                                       ...
                                       value="{{ old('warna', Str::startsWith($tridharma->warna ?? '', '#') ? $tridharma->warna : '#823ca2') }}"
                                       title="Pilih Warna"
                                ...
                                <input type="text"
                                       ...
                                       value="{{ old('warna', $tridharma->warna ?? '#823ca2') }}"
                                       placeholder="#823ca2"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('judul', $tridharma->judul) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="deskripsi"
                                  ...
                                  rows="3"
                                  placeholder="Contoh: Fokus riset ergonomi industri maritim dan sanitasi pesisir...">{{ old('deskripsi', $tridharma->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 mb-3">
                            ...
                            <input type="number"
                                   ...
                                   value="{{ old('urutan', $tridharma->urutan) }}"
                                   min="0"
                                   max="255">
                        ...
                        <div class="col-sm-8 mb-3 d-flex align-items-center pt-sm-4">
                            <div class="form-check form-switch">
                                ...
                                <input class="form-check-input"
                                       ...
                                       name="is_active"
                                       value="1"
                                       {{ old('is_active', $tridharma->is_active ? '1' : '0') == '1' ? 'checked' : '' }}>
...
function updatePreview() {
    ...
    const colorVal = document.getElementById('warna').value.trim() || '#823ca2';
