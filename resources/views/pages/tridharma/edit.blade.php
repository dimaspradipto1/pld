                    ...
                    <div class="row">
                        <div class="col-md-7 mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-light" id="icon-preview-box" style="font-size:22px;color:{{ old('warna', $tridharma->warna ?? '#56823D') }};min-width:52px;justify-content:center;">
                        ...
                        <div class="col-md-5 mb-3">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <input type="color"
                                       ...
                                       value="{{ old('warna', Str::startsWith($tridharma->warna ?? '', '#') ? $tridharma->warna : '#56823D') }}"
                                       title="Pilih Warna"
                                ...
                                <input type="text"
                                       ...
                                       value="{{ old('warna', $tridharma->warna ?? '#56823D') }}"
                                       placeholder="#56823D"
