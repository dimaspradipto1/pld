        ...
        <div class="card shadow-sm border-0" style="background:linear-gradient(135deg,#f5eefa,#fff);">
            ...
            <div class="card-body pt-2">
                <div class="p-3 rounded-3 border bg-white shadow-sm">
                    <div id="prev-icon-wrap" style="width:50px;height:50px;border-radius:12px;background:rgba(86,130,61,.12);display:flex;align-items:center;justify-content:center;margin-bottom:14px;">
                        <i id="prev-icon" class="bi {{ old('icon', $sarana->icon ?? 'bi-building') }}" style="font-size:24px;color:#56823D;"></i>
                    </div>
