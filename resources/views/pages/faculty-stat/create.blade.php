...
@section('content')
<div class="pagetitle">
    <h1>Tambah Statistik Fakultas</h1>
    <nav>
        <ol class="breadcrumb">
        ...
        <div class="card shadow-sm">
            <div class="card-header py-3">
                <h5 class="mb-0 fw-semibold">
                    <i class="bi bi-bar-chart-fill me-2 text-primary"></i>Form Tambah Data Statistik Fakultas
                </h5>
            </div>
            <div class="card-body pt-4">
                ...
                <div class="alert alert-info mb-4">
                    ...
                    <strong>Panduan:</strong> Isi angka statistik terkini. Gambar bersifat opsional — jika diisi akan tampil di sisi kanan section.
                    Gambar disarankan beresolusi <strong>600 × 400 px</strong> ke atas, format JPG/PNG/WebP.
                </div>
                ...
                <form action="{{ route('faculty-stat.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('title', 'FIKES UIS Dalam Angka') }}"
                    ...
                    <div class="mb-4">
                        ...
                        <div class="form-text">
                            ...
                            Foto gedung/kampus untuk tampil di sisi kanan section. Format: JPG, PNG, WebP. Maks 2MB.
                            Resolusi disarankan: 600 × 400 px.
                        </div>
                        @error('image')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        ...
                        <div id="previewWrap" class="mt-3 d-none">
                            ...
                            <img id="previewImg" src="" alt="Preview"
                                 style="max-width:100%;max-height:220px;object-fit:cover;border-radius:10px;border:1px solid #dee2e6">
                        </div>
                    </div>
