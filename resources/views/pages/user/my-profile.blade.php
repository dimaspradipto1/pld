            ...
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body profile-card pt-4 d-flex flex-column align-items-center text-center">
                    <div class="rounded-circle d-flex align-items-center justify-content-center mb-3 shadow-sm"
                         style="width: 100px; height: 100px; background: linear-gradient(135deg, #56823D 0%, #233618 100%); color: #ffffff; font-size: 40px; font-weight: 700;">
                        {{ strtoupper(substr($user->name, 0, 2)) }}
                    </div>
                    <h4 class="fw-bold mb-1 text-dark">{{ $user->name }}</h4>
                    <span class="badge px-3 py-2 rounded-pill mb-3" style="background: rgba(86, 130, 61, 0.14); color: #56823D; font-weight: 700; font-size: 12.5px;">
                    ...
                    <div class="tab-content pt-2">
                        ...
                        <div class="tab-pane fade profile-edit pt-2" id="profile-edit">
                            <form action="{{ route('user.update-my-profile') }}" method="POST">
                                ...
                                <div class="text-end">
                                    <button type="submit" class="btn text-white px-4 py-2 fw-semibold" style="background: #D99032;">
