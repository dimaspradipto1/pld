        ...
        <form action="{{ route('admin-statistik-mahasiswa.store') }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control tinymce-editor @error('keterangan') is-invalid @enderror" id="keterangan" name="keterangan" rows="6" placeholder="Tuliskan catatan khusus pendampingan, riwayat asesmen, kebutuhan alat bantu atau akomodasi belajar mahasiswa...">{{ old('keterangan') }}</textarea>
                    @error('keterangan')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
