            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-header bg-white py-3 d-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <button type="button" class="btn btn-sm btn-primary" id="btn-add-prodi" style="background: #D99032; border-color: #D99032;">
                            ...
                            <div class="card border prodi-item shadow-none rounded-3" style="background: #fafafa;" data-item-index="{{ $index }}">
                                <div class="card-header bg-white d-flex align-items-center justify-content-between py-2 border-bottom">
                                    <div class="d-flex align-items-center gap-2">
                                        <span class="badge bg-primary rounded-pill prodi-index-badge px-2 py-1" style="background: #56823D !important;">
                                            Menu #{{ $loop->iteration }}
                                        </span>
                ...
                <div class="card-footer bg-light py-3 d-flex justify-content-between align-items-center">
                    ...
                    <button type="submit" class="btn btn-primary px-4 rounded-3 fw-bold shadow-sm" style="background: #D99032; border-color: #D99032;">
