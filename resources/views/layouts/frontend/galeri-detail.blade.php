      ...
      <div class="col-lg-8" data-aos="fade-up">
        ...
        @else
          <div class="p-5 rounded-4 text-center text-white mb-4" style="background: linear-gradient(135deg, #1b2b13 0%, #56823D 100%);">
            <i class="bi bi-camera-fill" style="font-size: 64px; color: #D99032;"></i>
            ...
            <div>
              @foreach($otherGalleries as $other)
                <a href="{{ route('homepage.galeri.detail', $other->slug ?? $other->id) }}" class="other-galeri-item">
                  ...
                  @else
                    <div class="other-galeri-img d-flex align-items-center justify-content-center text-white" style="background: linear-gradient(135deg, #1b2b13, #56823D);">
