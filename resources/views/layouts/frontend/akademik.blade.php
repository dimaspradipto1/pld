  ...
  <div class="container">
    <div class="row g-4">
      ...
      <div class="col-lg-8" data-aos="fade-up">
        <div class="akademik-card">
          ...
          @if(!empty($item->link_url))
            <div class="p-4 rounded-4 mb-4 text-white d-flex flex-column flex-sm-row align-items-sm-center justify-content-between gap-3" style="background: linear-gradient(135deg, #1b2b13 0%, #56823D 100%);">
              <div>
      ...
      <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
        ...
        {{-- Widget Kontak / PMB --}}
        <div class="p-4 rounded-4 text-white" style="background: linear-gradient(135deg, #1b2b13 0%, #375326 100%); border: 1px solid rgba(255, 255, 255, 0.1);">
          <div class="badge px-3 py-1 rounded-pill mb-2" style="background: var(--pld-orange); color: #ffffff; font-weight: 800; font-size: 11px;">
            INFORMASI PMB
          </div>
