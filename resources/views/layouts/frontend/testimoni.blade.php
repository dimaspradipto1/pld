...
<style>
  .rating-score-box {
    background: linear-gradient(135deg, #1b2b13 0%, #375326 60%, #56823D 100%);
    border-radius: 20px;
    padding: 32px;
    color: #ffffff;
    text-align: center;
    box-shadow: 0 10px 25px rgba(86, 130, 61, 0.2);
    height: 100%;
    display: flex;
  ...
  .progress-bar-pld {
    background: linear-gradient(90deg, #A8D27D 0%, #56823D 100%);
    height: 100%;
    border-radius: 10px;
