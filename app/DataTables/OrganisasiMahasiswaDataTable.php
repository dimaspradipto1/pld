    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('logo_preview', function ($o) {
                ...
                return '<div class="rounded d-flex align-items-center justify-content-center text-white fw-bold shadow-sm" style="width: 44px; height: 44px; background: linear-gradient(135deg, #1b2b13 0%, #56823D 100%); font-size: 13px;">' . $initial . '</div>';
            })
            ...
            ->editColumn('kategori', function ($o) {
                return '<span class="badge" style="background:#56823D; color:#fff; font-size:11.5px; padding:5px 10px;">' . e($o->kategori) . '</span>';
            })
